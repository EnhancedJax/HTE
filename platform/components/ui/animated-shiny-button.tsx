  ...
  return (
    <>
      <style jsx>{`
        ...
        /* Default variant: no shine, still interactable */
        .shiny-cta.plain,
        .shiny-cta-link.plain {
          background: var(--color-muted);
          box-shadow: inset 0 0 0 1px var(--color-border);
          animation: none;
        }
        .shiny-cta.plain::before,
        .shiny-cta.plain::after,
        .shiny-cta-link.plain::before,
        .shiny-cta-link.plain::after {
          display: none;
        }
        .shiny-cta.plain span::before,
        .shiny-cta-link.plain span::before {
          display: none;
        }
        .shiny-cta.plain:is(:hover, :focus-visible),
        .shiny-cta-link.plain:is(:hover, :focus-visible) {
          filter: brightness(0.95);
        }
      `}</style>

      <button
        className={`shiny-cta group ${variant === "default" ? "plain" : ""} ${className}`}
        {...rest}
      >
